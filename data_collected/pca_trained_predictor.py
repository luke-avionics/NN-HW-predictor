...
pca = PCA(n_components=net_arch[0])
pca.fit(train_x)
...
writer=SummaryWriter("pca_error_loss_net"+str(net_arch)+"drop_out"+str(drop_out)+"_layer"+str(layer)+"_"+"{:.0e}".format(weight_decay)+"_"+str(lr_decay).replace(".","_")+"initial_lr_"+str(initial_lr)+"_lr_step"+str(lr_step)+"_"+str(total_epochs)+"_logging.log")
...
for epoch in pbar:  # loop over the dataset multiple times
    ...
    if epoch % 20==19:
        torch.save(net.state_dict(), "pca_error_loss_net"+str(net_arch)+"drop_out"+str(drop_out)+"_layer"+str(layer)+"_"+"{:.0e}".format(weight_decay)+"_"+str(lr_decay).replace(".","_")+"initial_lr_"+str(initial_lr)+"_lr_step"+str(lr_step)+"_"+str(total_epochs)+"_tmp_weight.pth")
    pbar.update()
