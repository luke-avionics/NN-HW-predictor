...
def capsulated_asic_model(block_info_test,quant_list,params_input,channel_part,cifar,edd):
    ...
    #net_struct=copy.deepcopy(alexnet)
    ...
    for i, layer_struct in enumerate(net_struct):
        ...
        ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("source /home/hy34/.bashrc;\
                                                              ...
                                                              timeout -s SIGINT 60s /home/hy34/accelergy_luke/timeloop/build/timeloop-mapper "+network_config+" arch/components/*.yaml "+hw_arch_config+" constraints/eyeriss_like* "+mapper_config+" > /dev/null 2>&1;\
