...
def capsuled_predictor(input_params_set, block_info_test,quant_list,cifar):
    ...
    platform_specs={'dsp':204,'bram':700}
    #print(net_struct,accelerator_wise_budget)
...
def design_choice_gen_apq(cifar): 
    if cifar:
        ...
        acc1_space={'comp_mode':[1],'trbuff':[4,2,1],'tcbuff':[4,2,1],'tmbuff':[8,4,2,1],'tnbuff':[8,4,2,1], 'tr':[4,2,1],'tc':[4,2,1],'tm':[8,4,2,1],'tn':[8,4,2,1]}
        ...
        dw_acc1_space={'comp_mode':[0,1],'trbuff':[4,2,1],'tcbuff':[4,2,1],'tmbuff':[16,8,4,2,1],'tnbuff':[1], 'tr':[4,2,1],'tc':[4,2,1],'tm':[16,8,4,2,1],'tn':[1]}
        #dw_acc2_space={'comp_mode':[0,1],'trbuff':[4,2,1],'tcbuff':[4,2,1],'tmbuff':[32,16,8,4,2,1],'tnbuff':[1], 'tr':[4,2,1],'tc':[4,2,1],'tm':[32,16,8,4,2,1],'tn':[1]}
    ...
    return (acc1_space, dw_acc1_space)
output_q=Queue()
def worker(id,block_info_test):   
    ...
    cifar=False
    acc1_space,dw_acc1_space=design_choice_gen_apq(cifar=cifar)
    latency_list=[]
    best_throughput=0 
